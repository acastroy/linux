...
#define TW5864_EMU_EN_SEN        (1 << 2)  /* Enable bit for Sensor Interface module */
#define TW5864_EMU_EN_BHOST      (1 << 3)  /* Enable bit for Host Burst Access */
#define TW5864_EMU_EN_LPF        (1 << 4)  /* Enable bit for Loop Filter module */
...
#define TW5864_VLC_SLICE_END     (1 << 0)  /* VLC Slice end flag */
#define TW5864_MAS_SLICE_END     (1 << 4)  /* Master Slice End Flag */
#define TW5864_START_NSLICE     (1 << 15)  /* Host to start a new slice Address */

#define TW5864_ENC_BUF_PTR_REC1    0x0010  /* [15:0] Two bit for each channel
                                              (channel 0 ~ 7). Each two bits are
                                              the buffer pointer for the last
                                              encoded frame of the corresponding
                                              channel.*/

#define TW5864_DSP_QP              0x0018  /* [5:0] DSP_MB_QP and [15:10] DSP_LPF_OFFSET */
/* Define controls in register TW5864_DSP_QP */
#define TW5864_DSP_MB_QP           0x003f  /* [5:0] H264 QP Value for codec */
#define TW5864_DSP_LPF_OFFSET      0xfc00  /* [15:10] H264 LPF_OFFSET Address
                                              (Default 0) */

#define TW5864_DSP_CODEC           0x001C  /*  */
/* Define controls in register TW5864_DSP_CODEC */
#define TW5864_DSP_CODEC_MODE    (1 << 0)  /* 0: Encode (TW5864 Default)
                                              1: Decode */
#define TW5864_VLC_BUF_ID        (7 << 2)  /* 0->3 4 VLC data buffer in DDR (1M each)
                                              0->7 8 VLC data buffer in DDR (512k each) */
#define TW5864_CIF_MAP_MD        (1 << 6)  /* 0 4CIF in 1 MB
                                              1 1CIF in 1 MB */
#define TW5864_HD1_MAP_MD        (1 << 7)  /* 0 2 falf D1 in 1 MB
                                              1 1 half D1 in 1 MB */
#define TW5864_VLC_VLD           (1 << 8)  /* VLC Stream valid */
#define TW5864_MV_VECT_VLD       (1 << 9)  /* MV Vector Valid */
#define TW5864_MV_FLAG_VLD      (1 << 10)  /* MV Flag Valid */

#define TW5864_DSP_SEN             0x0020  /*  */
/* Define controls in register TW5864_DSP_SEN */
#define TW5864_DSP_SEN_PIC_LU      0x000f  /* Org Buffer Base for Luma (default 0) */
#define TW5864_DSP_SEN_PIC_CHM     0x00f0  /* Org Buffer Base for Chroma (default 4) */
#define TW5864_DSP_SEN_PIC_MAX     0x0700  /* Maximum Number of Buffers (default 4) */
#define TW5864_DSP_SEN_HFULL       0x1000  /* Original Frame D1 or HD1 switch
                                              (Default 0) */

#define TW5864_DSP_REF_PIC         0x0024  /*  */
/* Define controls in register TW5864_DSP_REF_PIC */
#define TW5864_DSP_REF_PIC_LU      0x000f  /* Ref Buffer Base for Luma (default 0) */
#define TW5864_DSP_REF_PIC_CHM     0x00f0  /* Ref Buffer Base for Chroma (default 4) */
#define TW5864_DSP_REF_PIC_MAX     0x0700  /* Maximum Number of Buffers (default 4) */

#define TW5864_SEN_EN_CH           0x0028  /* [15:0] SEN_EN_CH[n] SENIF
                                              original frame capture enable for
                                              each channel */

#define TW5864_DSP                 0x002C  /*  */
/* Define controls in register TW5864_DSP */
#define TW5864_DSP_ENC_CHN         0x000f  /* The ID for channel selected for
                                              encoding operation */
#define TW5864_DSP_MB_WAIT         0x0010  /* See DSP_MB_DELAY below */
#define TW5864_DSP_CHROM_SW        0x0020  /* DSP Chroma Switch
                                              0 DDRB
                                              1 DDRA */
#define TW5864_DSP_FLW_CNTL        0x0040  /* VLC Flow Control: 1 for enable */
#define TW5864_DSP_MB_DELAY        0x0f00  /* If DSP_MB_WAIT == 0, MB delay is
                                              DSP_MB_DELAY * 16
...
#define TW5864_DDR_PAGE_CNTL       0x00ff  /* DDR Single Access Page Number */
#define TW5864_DDR_BRST_EN      (1 << 13)  /* DDR-DPR Burst Read Enable */
#define TW5864_DDR_AB_SEL       (1 << 14)  /* DDR A/B Select as HOST access
                                              0 Select DDRA
                                              1 Select DDRB */
#define TW5864_DDR_MODE         (1 << 15)  /* DDR Access Mode Select
                                              0 Single R/W Access (Host <-> DDR)
                                              1 Burst R/W Access (Host <-> DPR) */

/* The original frame capture pointer. Two bits for each channel */
#define TW5864_SENIF_ORG_FRM_PTR1  0x0038  /* SENIF_ORG_FRM_PTR [15:0] */
#define TW5864_SENIF_ORG_FRM_PTR2  0x003C  /* SENIF_ORG_FRM_PTR [31:16] */
...
#define TW5864_ENC_BUF_PTR_REC2    0x004C  /* [15:0]: ENC_BUF_PTR_REC[31:16]
...
#define TW5864_CH_MV_PTR1          0x0060  /* [1:0] CH0_MV_PTR,
                                              ..., [15:14] CH7_MV_PTR */
#define TW5864_CH_MV_PTR2          0x0064  /* [1:0] CH8_MV_PTR,
                                              ..., [15:14] CH15_MV_PTR */

#define TW5864_RST_MV_PTR          0x0068  /* [15:0] Reset Current MV Flag
                                              Status Pointer for Channel n
                                              (one bit each) */
#define TW5864_INTERLACING         0x0200
/* Define controls in register TW5864_INTERLACING */
#define TW5864_DSP_INTER_ST      (1 << 1)  /* Inter_Mode Start. 2-nd bit? A
                                              guess. Missing in datasheet */
#define TW5864_DI_EN             (1 << 2)  /* Deinterlacer Enable */
#define TW5864_DI_MD             (1 << 3)  /* De-interlacer Mode
                                              1 Shuffled frame
                                              0 Normal Un-Shuffled Frame */
#define TW5864_DSP_DWN_X         (3 << 4)  /* Down scale original frame in X direction
                                              11: Un-used
                                              10: down-sample to 1/4
                                              01: down-sample to 1/2
                                              00: down-sample disabled */
#define TW5864_DSP_DWN_Y         (3 << 6)  /* Down scale original frame in Y direction
                                              11: Un-used
                                              10: down-sample to 1/4
                                              01: down-sample to 1/2
                                              00: down-sample disabled */
#define TW5864_DUAL_STR          (1 << 8)  /* 1 Dual Stream
                                              0 Single Stream */

#define TW5864_DSP_REF             0x0204
/* Define controls in register TW5864_DSP_REF */
#define TW5864_DSP_REF_FRM         0x000f  /* Number of reference frame (Default 1 for TW5864B) */
#define TW5864_DSP_WIN_SIZE        0x02f0  /* Window size */

#define TW5864_DSP_SKIP            0x0208
/* Define controls in register TW5864_DSP_SKIP */
#define TW5864_DSP_SKIP_OFEN       0x0080  /* Skip Offset Enable bit
                                              0 DSP_SKIP_OFFSET value is not used (default 8)
                                              1 DSP_SKIP_OFFSET value is used in HW */
#define TW5864_DSP_SKIP_OFFSET     0x007f  /* Skip mode cost offset (default 8) */

#define TW5864_MOTION_SEARCH_ETC   0x020C
/* Define controls in register TW5864_MOTION_SEARCH_ETC */
#define TW5864_QPEL_EN           (1 << 0)  /* Enable quarter pel search mode */
#define TW5864_HPEL_EN           (1 << 1)  /* Enable half pel search mode */
#define TW5864_ME_EN             (1 << 2)  /* Enable motion search mode */
#define TW5864_INTRA_EN          (1 << 3)  /* Enable Intra mode */
#define TW5864_SKIP_EN           (1 << 4)  /* Enable Skip Mode */
#define TW5864_SRCH_OPT          (3 << 5)  /* Search Option (Default 2‟b01) */

#define TW5864_DSP_ENC_REC         0x0210
/* Define controls in register TW5864_DSP_ENC_REC */
#define TW5864_DSP_ENC_REF_PTR     0x0007  /* Reference Buffer Pointer for encoding */
#define TW5864_DSP_REC_BUF_PTR     0x7000  /* Reconstruct Buffer pointer */

#define TW5864_DSP_REF_MVP_LAMBDA  0x0214  /* [15:0] Lambda Value for H264 */

#define TW5864_DSP_PIC_MAX_MB      0x0218
/* Define controls in register TW5864_DSP_PIC_MAX_MB */
#define TW5864_DSP_PIC_MAX_MB_Y    0x007f  /* The MB number in Y direction for a frame */
#define TW5864_DSP_PIC_MAX_MB_X    0x7f00  /* The MB number in X direction for a frame */

#define TW5864_DSP_ENC_ORG_PTR_REG  0x021C  /* The original frame pointer for encoding */
#define TW5864_DSP_ENC_ORG_PTR_MASK 0x7000  /* Mask to use with TW5864_DSP_ENC_ORG_PTR */
#define TW5864_DSP_ENC_ORG_PTR_SHIFT    12  /* Number of bits to shift with TW5864_DSP_ENC_ORG_PTR */

#define TW5864_DSP_OSD_ATTRI_BASE  0x0220  /* DDR base address of OSD rectangle attribute data */
#define TW5864_DSP_OSD_ENABLE      0x0228  /* OSD enable bit for each channel */

#define TW5864_ME_MV_VEC1          0x0280  /* 0x0280 ~ 0x029C – Motion Vector for 1st 4x4 Block, e.g., 80 (X), 84 (Y) */
#define TW5864_ME_MV_VEC2          0x02A0  /* 0x02A0 ~ 0x02BC – Motion Vector for 2nd 4x4 Block, e.g., A0 (X), A4 (Y) */
#define TW5864_ME_MV_VEC3          0x02C0  /* 0x02C0 ~ 0x02DC – Motion Vector for 3rd 4x4 Block, e.g., C0 (X), C4 (Y) */
#define TW5864_ME_MV_VEC4          0x02E0  /* 0x02E0 ~ 0x02FC – Motion Vector for 4th 4x4 Block, e.g., E0 (X), E4 (Y) */

#define TW5864_DSP_I4x4_OFFSET     0x040C  /* [5:0]
                                              if (intra16x16_cost < (intra4x4_cost+dsp_i4x4_offset))
                                              Intra_mode = intra16x16_mode
                                              Else
                                              Intra_mode = intra4x4_mode */

#define TW5864_DSP_INTRA_MODE      0x0410  /* [6:4]
                                              0x5 Only 4x4
                                              0x6 Only 16x16
                                              0x7 16x16 & 4x4 */
...
#define TW5864_DSP_I4x4_WEIGHT     0x0414  /* [5:0]
                                              WEIGHT Factor for I4x4 cost
                                              calculation (QP dependent)*/

#define TW5864_DSP_RESID_MODE_OFFSET 0x0604  /* [7:0]
...
#define TW5864_QUAN_TAB            0x0800  /* 0x0800 ~ 0x09FF - Quantization TABLE Values */
...
#define TW5864_PROG_A            (1 << 0)  /* 1 Progressive in part A in bus n
                                              0 Interlaced in part A in bus n */
#define TW5864_PROG_B            (1 << 1)  /* 1 Progressive in part B in bus n
                                              0 Interlaced in part B in bus n */
#define TW5864_FRAME             (1 << 2)  /* 1 Frame Mode in bus n
                                              0 Field Mode in bus n */
#define TW5864_BUS_D1            (3 << 3)  /* 0 4CIF in bus n
...
#define TW5864_SENIF_HOR_MIR       0x0D08  /* [15:0] Horizontal Mirror for channel n */
...
#define TW5864_FULL_HALF_FLAG      0x0D50  /* 1: the bus mapped Channel n Full D1
                                              0: the bus mapped Channel n Half D1*/

#define TW5864_FULL_HALF_MODE_SEL  0x0D54  /* 0 The bus mapped Channel select
                                              partA Mode
...
#define TW5864_VLC_SLICE_QP        0x003f  /* QP Value used by H264 CAVLC */
#define TW5864_VLC_BYTE_SWP      (1 << 6)  /* Swap byte order of VLC stream in d-word.
                                              1 Normal (VLC output= [31:0])
                                              0 Swap (VLC output={[23:16],[31:24],[7:0], [15:8]}) */
#define TW5864_VLC_ADD03_EN      (1 << 7)  /* Enable Adding 03 circuit for VLC stream */
...
#define TW5864_VLC_INF_SEL      (1 << 13)  /* Synchronous Interface select for VLC Stream
                                              1 CDC_VLCS_MAS read VLC stream
                                              0 CPU read VLC stream */
#define TW5864_VLC_OVFL_CNTL    (1 << 14)  /* Enable VLC overflow control */
#define TW5864_VLC_PCI_SEL      (1 << 15)  /* 1 PCI Master Mode
                                              0 Non PCI Master Mode */
#define TW5864_VLC_A03_DISAB    (1 << 16)  /* 0 Enable Adding 03 to VLC header and stream
...
#define TW5864_SLICE_TOTAL_BIT     0x1004  /* Total number of bit in the slice */
#define TW5864_RES_TOTAL_BIT       0x1008  /* Total number of bit in the residue */

#define TW5864_VLC_BUF             0x100C
/* Define controls in register TW5864_VLC_BUF */
#define TW5864_VLC_BK0_FULL      (1 << 0)  /* VLC BK0 full status, write ‘1’ to clear */
#define TW5864_VLC_BK1_FULL      (1 << 1)  /* VLC BK1 full status, write ‘1’ to clear */
#define TW5864_VLC_END_SLICE     (1 << 2)  /* VLC end slice status, write ‘1’ to clear */
#define TW5864_DSP_RD_OF         (1 << 3)  /* VLC Buffer overflow status, write ‘1’ to clear */
...
#define TW5864_TOTAL_COEF_NO       0x1010  /* [15:0] Total coefficient number in a frame */
#define TW5864_VLC_DSP_INTR        0x1014  /* [0] VLC Encoder Interrupt. Write ‘1’ to clear */
#define TW5864_VLC_STREAM_CRC      0x1018  /* [31:0] VLC stream CRC checksum */

#define TW5864_VLC_RD              0x101C
/* Define controls in register TW5864_VLC_RD */
#define TW5864_VLC_RD_MEM        (1 << 0)  /* 1 Read VLC lookup Memory
                                              0 Read VLC Stream Memory */
#define TW5864_VLC_RD_BRST       (1 << 1)  /* 1 Read VLC Stream Memory in burst mode
...
#define TW5864_CFG_1MS_CNT         0x4000  /* [31:0] config 1ms cnt = Realtime clk/1000 */

#define TW5864_ADPCM               0x4004
/* Define controls in register TW5864_ADPCM */
#define TW5864_ADPCM_DEC         (1 << 0)  /* ADPCM decoder enable */
#define TW5864_ADPCM_IN_DATA     (1 << 1)  /* ADPCM input data enable */
#define TW5864_ADPCM_ENC         (1 << 2)  /* ADPCM encoder enable */

#define TW5864_AUD                 0x4008
/* Define controls in register TW5864_AUD */
#define TW5864_AUD_ORG_CH_EN       0x00ff  /* Record path PCM Audio enable bit
                                              for each channel */
#define TW5864_SPK_ORG_EN       (1 << 16)  /* Speaker path PCM Audio Enable */
#define TW5864_AD_BIT_MODE      (1 << 17)  /* 0 16bit
                                              1 8bit */
#define TW5864_AUD_TYPE_SHIFT          18
#define TW5864_AUD_TYPE (0xf << TW5864_AUD_TYPE_SHIFT)  /* 0 PCM
                                                           3 ADPCM */
#define TW5864_AUD_SAMPLE_RATE_SHIFT   22
#define TW5864_AUD_SAMPLE_RATE (3 << TW5864_AUD_SAMPLE_RATE_SHIFT)  /* 0 8K
                                                                       1 16K */
...
#define TW5864_TEST_ADLOOP_EN   (1 << 30)  /* Enable AD Loopback Test */
#define TW5864_AUD_MODE         (1 << 31)  /* 0 Asynchronous Mode or PCI target mode
                                              1 PCI Initiator Mode */

#define TW5864_AUD_ADPCM           0x400C
/* Define controls in register TW5864_AUD_ADPCM */
#define TW5864_AUD_ADPCM_CH_EN     0x00ff  /* Record path ADPCM audio channel
                                              enable, one bit for each */
#define TW5864_SPK_ADPCM_EN     (1 << 16)  /* Speaker path ADPCM audio channel enable */
...
#define TW5864_ADPCM_ENC_WR_PTR1   0x401C  /* ADPCM_ENC_WR_PTR[29:0] */
#define TW5864_ADPCM_ENC_WR_PTR2   0x4020  /* ADPCM_ENC_WR_PTR[50:30] */

#define TW5864_ADPCM_ENC_RD_PTR1   0x4024  /* ADPCM_ENC_RD_PTR[29:0] */
#define TW5864_ADPCM_ENC_RD_PTR2   0x4028  /* ADPCM_ENC_RD_PTR[50:30] */

#define TW5864_ADPCM_DEC_RD_WR_PTR 0x402C  /* [3:0] rd ch0, [7:4] rd ch1,
...
Bit[67:64] ch16
*/
#define TW5864_AD_ORIG_WR_PTR1     0x4030  /* AD_ORIG_WR_PTR[31:0] */
#define TW5864_AD_ORIG_WR_PTR2     0x4034  /* AD_ORIG_WR_PTR[63:32] */
#define TW5864_AD_ORIG_WR_PTR3     0x4038  /* AD_ORIG_WR_PTR[67:64] */

#define TW5864_AD_ORIG_RD_PTR1     0x403C  /* AD_ORIG_RD_PTR[31:0] */
#define TW5864_AD_ORIG_RD_PTR2     0x4040  /* AD_ORIG_RD_PTR[63:32] */
#define TW5864_AD_ORIG_RD_PTR3     0x4044  /* AD_ORIG_RD_PTR[67:64] */
...
#define TW5864_PCI_DATA_SEL        0xffff  /* The register is applicable to PCI
                                              initiator mode only. Used to
                                              select PCM(0) or ADPCM(1) audio
                                              data sent to PC. One bit for each
                                              channel */
#define TW5864_PCI_FLOW_EN      (1 << 16)  /* Audio flow control mode selection bit.
                                              0 Flow control disabled. TW5864
                                              continuously sends audio frame to
                                              PC (initiator mode)
                                              1 Flow control enabled */
#define TW5864_PCI_AUD_FRM_EN   (1 << 17)  /* When PCI_FLOW_EN is set, PCI need
                                              to toggle this bit to send an
                                              audio frame to PC. One toggle to
                                              send one frame. */

#define TW5864_CS2DAT_CNT          0x8000  /* [1:0] CS valid to data valid CLK cycles when writing operation */
#define TW5864_DATA_VLD_WIDTH      0x8004  /* [2:0] Data valid signal width by system clock cycles */

#define TW5864_SYNC                0x8008
/* Define controls in register TW5864_SYNC */
#define TW5864_SYNC_CFG          (1 << 7)  /* 0 vlc stream to syncrous port
                                              1 vlc stream to ddr buffers */
#define TW5864_SYNC_ADR_EDGE     (1 << 0)  /* 0 SYNC Address sampled on Rising edge
                                              1 SYNC Address sampled on Falling edge */
#define TW5864_VLC_STR_DELAY_SHIFT      1
#define TW5864_VLC_STR_DELAY     (3 << TW5864_VLC_STR_DELAY_SHIFT)  /* 0 No system delay
                                                                       1 One system clock delay
                                                                       2 Two system clock delay
                                                                       3 Three system clock delay */
#define TW5864_VLC_OUT_EDGE      (1 << 3)  /* 0 Rising edge output
                                              1 Falling edge output */

#define TW5864_I2C_PHASE_CFG       0x800C  /* [1:0]
...
*/
#define TW5864_SYSPLL1             0x8018  /* SYSPLL_M[7:0] */
/* Define controls in register TW5864_SYSPLL1 */
#define TW5864_SYSPLL_M_LOW        0x00ff

#define TW5864_SYSPLL2             0x8019  /* [2:0]: SYSPLL_M[10:8], [7:3]: SYSPLL_N[4:0] */
...
#define TW5864_SYSPLL3             0x8020  /* [1:0]: SYSPLL_N[6:5], [3:2]: SYSPLL_P, [4]: SYSPLL_IREF, [7:5]: SYSPLL_CP_SEL */
...
#define TW5864_SYSPLL_IREF       (1 << 4)  /* SYSPLL bias current control
...
#define TW5864_SYSPLL4             0x8021  /* [1:0]: SYSPLL_VCO, [3:2]: SYSPLL_LP_X8, [5:4]: SYSPLL_ICP_SEL, [6]: SYSPLL_LPF_5PF, [7]: SYSPLL_ED_SEL */
/* Define controls in register TW5864_SYSPLL4 */
#define TW5864_SYSPLL_VCO            0x03  /* SYSPLL_VCO VCO Range selection
                                              00 5 ~ 75 MHz
                                              01 50 ~ 140 MHz
                                              10 110 ~ 320 MHz
                                              11 270 ~ 700 MHz */
#define TW5864_SYSPLL_LP_X8_SHIFT       2
#define TW5864_SYSPLL_LP_X8 (0x03 << TW5864_SYSPLL_LP_X8_SHIFT)  /* Loop resister
                                                                    0 38.5K ohms
                                                                    1 6.6K ohms (default)
                                                                    2 2.2K ohms
                                                                    3 1.1K ohms */
#define TW5864_SYSPLL_ICP_SEL_SHIFT     4
#define TW5864_SYSPLL_ICP_SEL (0x03 << TW5864_SYSPLL_ICP_SEL_SHIFT)  /* PLL charge pump fine tune
                                                                        00 x1 (default)
                                                                        01 x1/2
                                                                        10 x1/7
                                                                        11 x1/8 */
#define TW5864_SYSPLL_LPF_5PF    (1 << 6)  /* PLL low pass filter phase margin adjustment
                                              0 no 5pF (default)
                                              1 5pF added */
#define TW5864_SYSPLL_ED_SEL     (1 << 7)  /* PFD select edge for detection
                                              0 Falling edge (default)
                                              1 Rising edge */

#define TW5864_SYSPLL5             0x8024  /* [0]: SYSPLL_RST, [4]: SYSPLL_PD */
/* Define controls in register TW5864_SYSPLL5 */
#define TW5864_SYSPLL_RST        (1 << 0)  /* Reset SYSPLL */
#define TW5864_SYSPLL_PD         (1 << 4)  /* Power down SYSPLL */

#define TW5864_PLL_CFG             0x801C
/* Define controls in register TW5864_PLL_CFG */
#define TW5864_SRST              (1 << 0)  /* Issue Soft Reset from Async Host Interface / PCI Interface clock domain.
                                              Become valid after sync to the xtal clock domain. This bit is set only if
                                              LOAD register bit is also set to 1. */
#define TW5864_SYSPLL_CFG        (1 << 2)  /* Issue SYSPLL (166 MHz) configuration latch from Async host interface / PCI
                                              Interface clock domain. The configuration setting becomes effective only if
                                              LOAD register bit is also set to 1. */
#define TW5864_SPLL_CFG          (1 << 4)  /* Issue SPLL (108 MHz) configuration load from Async host interface / PCI
                                              Interface clock domain. The configuration setting becomes effective only if
                                              the LOAD register bit is also set to 1. */
#define TW5864_LOAD              (1 << 3)  /* Set this bit to latch the SRST, SYSPLL_CFG, SPLL_CFG setting into the xtal
                                              clock domain to restart the PLL. This bit is self cleared. */

#define TW5864_SPLL                0x8028  /* SPLL_IREF, SPLL_LPX4, SPLL_CPX4, SPLL_PD, SPLL_DBG */

/* 0x8800 ~ 0x88FC -- Interrupt Register Map */
#define TW5864_TRIGGER_MODE_L      0x8800  /* Trigger mode of interrupt source 0 ~ 15
                                              1 Edge trigger mode
                                              0 Level trigger mode */
#define TW5864_TRIGGER_MODE_H      0x8804  /* Trigger mode of interrupt source 16 ~ 31 */
#define TW5864_INTR_ENABLE_L       0x8808  /* Enable of interrupt source 0 ~ 15 */
#define TW5864_INTR_ENABLE_H       0x880C  /* Enable of interrupt source 16 ~ 31 */
#define TW5864_INTR_CLR_L          0x8810  /* Clear interrupt command of interrupt source 0 ~ 15 */
#define TW5864_INTR_CLR_H          0x8814  /* Clear interrupt command of interrupt source 16 ~ 31 */
#define TW5864_INTR_ASSERT_L       0x8818  /* Assertion of interrupt source 0 ~ 15
                                              1 High level or pos-edge is assertion
                                              0 Low level or neg-edge is assertion */
#define TW5864_INTR_ASSERT_H       0x881C  /* Assertion of interrupt source 16 ~ 31 */
#define TW5864_INTR_OUT_LEVEL      0x8820  /* Output level of interrupt
                                              1 Interrupt output is high assertion
                                              0 Interrupt output is low assertion */
#define TW5864_INTR_STATUS_L       0x8838  /* Status of interrupt source 0 ~ 15
                                              ...
                                              Bit[13:15]: Reserved */
#define TW5864_INTR_STATUS_H       0x883C  /* Status of interrupt source 16 ~ 31
                                              Bit[0]: Reserved
...
#define TW5864_H264EN_CH_STATUS    0x9000  /* H264EN_CH_STATUS[n] Status of
                                              ...
                                              1 Channel Enabled
                                              0 Channel Disabled */
#define TW5864_H264EN_CH_EN        0x9004  /* [15:0] H264EN_CH_EN[n] H264
                                              Encoding Path Enable for channel
                                              1 Channel Enabled
                                              0 Channel Disabled */
#define TW5864_H264EN_CH_DNS       0x9008  /* H264EN_CH_DNS[n] H264 Encoding
                                              Path Downscale Video Decoder
                                              Input for channel n
                                              1 Downscale Y to 1/2
                                              0 Does not downscale */
#define TW5864_H264EN_CH_PROG      0x900C  /* H264EN_CH_PROG[n] H264 Encoding
                                              Path channel n is progressive
                                              1 Progressive (Not valid for TW5864)
                                              0 Interlaced (TW5864 default) */
#define TW5864_H264EN_BUS_MAX_CH   0x9010  /* [3:0] H264EN_BUS_MAX_CH[n]
...
#define TW5864_H264EN_RATE_MAX_LINE_REG1 0x9014  /* [4:0] H264EN_RATE_MAX_LINE_0
                                                    [9:5] H264EN_RATE_MAX_LINE_1 */
#define TW5864_H264EN_RATE_MAX_LINE_REG2 0x9018  /* [4:0] H264EN_RATE_MAX_LINE_2
...
*/
#define TW5864_H264EN_CH_FMT_REG1  0x9020  /* [1:0]: H264EN_CH0_FMT,
                                              ..., [15:14]: H264EN_CH7_FMT */
#define TW5864_H264EN_CH_FMT_REG2  0x9024  /* [1:0]: H264EN_CH8_FMT (?),
...
#define TW5864_GPIO_DATA           0x00ff  /* GPIO DATA of Group n */
#define TW5864_GPIO_OEN_SHIFT           8
#define TW5864_GPIO_OEN (0xff << TW5864_GPIO_OEN_SHIFT)  /* GPIO Output Enable of Group n */

/* 0xA000 ~ 0xA8FF – DDR Controller Register Map */
/* DDR Controller A */
#define TW5864_RD_ACK_VLD_MUX      0xA000  /* [2:0] Data valid counter after
...
#define TW5864_TRAS_CNT_MAX        0x000f  /* Tras value, the minimum cycle of
...
#define TW5864_CAS_LATENCY         0xA008  /* [2:0] CAS latency, the delay
                                              cycle between internal read
                                              command and the availability of
                                              the first bit of output data,
                                              default is 3 */
#define TW5864_DDR_REF_CNTR_MAX    0xA00C  /* [15:0] Maximum average periodic
...
#define TW5864_MASTER_MODE       (1 << 0)  /* 0 Common read/write mode
                                              1 DDR self-test mode */
#define TW5864_SINGLE_PROC       (1 << 1)  /* 0 DDR self-test single read/write
                                              1 DDR self-test burst read/write */
#define TW5864_WRITE_FLAG        (1 << 2)  /* 0 DDR self-test write command
                                              1 DDR self-test read command */
#define TW5864_DATA_MODE_SHIFT          4
#define TW5864_DATA_MODE (0x3 << TW5864_DATA_MODE_SHIFT)  /* 0x0 write 32'haaaa5555 to DDR
                                                             0x1 write 32'hffffffff to DDR
                                                             0x2 write 32'hha5a55a5a to DDR
                                                             0x3 write increasing data to DDR */

#define TW5864_BURST_CNTR_MAX      0xA024  /* [7:0] The maximum data of one burst in DDR self-test mode */
#define TW5864_DDR_PROC_CNTR_MAX_L 0xA028  /* [15:0] The maximum burst counter (bit 15~0) in DDR self-test mode*/
#define TW5864_DDR_PROC_CNTR_MAX_H 0xA02C  /* The maximum burst counter (bit 31~16) in DDR self-test mode */
#define TW5864_DDR_SELF_TEST_CMD   0xA030  /* [0]: Start one DDR self-test */
#define TW5864_ERR_CNTR_L          0xA034  /* The maximum error counter (bit 15 ~ 0) in DDR self-test */

#define TW5864_ERR_CNTR_H_AND_FLAG 0xA038
/* Define controls in register TW5864_ERR_CNTR_H_AND_FLAG */
#define TW5864_ERR_CNTR_H_MASK     0x3fff  /* The maximum error counter (bit 30 ~ 16) in DDR self-test */
#define TW5864_END_FLAG            0x8000  /* DDR self-test end flag */
...
#define TW5864_HW_VERSION          0xB004  /* [15:0] Default is C013 */

#define TW5864_REQS_ENABLE         0xB010
/* Define controls in register TW5864_REQS_ENABLE */
#define TW5864_AUD_DATA_IN_ENB   (1 << 0)  /* Audio data in to DDR enable (default 1) */
#define TW5864_AUD_ENC_REQ_ENB   (1 << 1)  /* Audio encode request to DDR enable (default 1) */
#define TW5864_AUD_DEC_REQ0_ENB  (1 << 2)  /* Audio decode request0 to DDR enable (default 1) */
#define TW5864_AUD_DEC_REQ1_ENB  (1 << 3)  /* Audio decode request1 to DDR enable (default 1) */
#define TW5864_VLC_STRM_REQ_ENB  (1 << 4)  /* VLC stream request to DDR enable (default 1) */
#define TW5864_DVM_MV_REQ_ENB    (1 << 5)  /* H264 MV request to DDR enable (default 1) */
#define TW5864_MVD_REQ_ENB       (1 << 6)  /* mux_core MVD request to DDR enable (default 1) */
#define TW5864_MVD_TMP_REQ_ENB   (1 << 7)  /* mux_core MVD temp data request to DDR enable (default 1) */
#define TW5864_JPEG_REQ_ENB      (1 << 8)  /* JPEG request to DDR enable (default 1) */
#define TW5864_MV_FLAG_REQ_ENB   (1 << 9)  /* mv_flag request to DDR enable (default 1) */

#define TW5864_ARB12               0xB018
/* Define controls in register TW5864_ARB12 */
#define TW5864_ARB12_ENB        (1 << 15)  /* ARB12 Enable (default 1) */
#define TW5864_ARB12_TIME_OUT_CNT  0x7fff  /* ARB12 maximum value of time out counter (default 15‟h1FF) */
...
#define TW5864_IND_ADDR        0x0000ffff  /* Address used to access indirect register space */
#define TW5864_BUSY             (1 << 31)  /* Wait until this bit is „0‟ before using indirect access */
#define TW5864_ENABLE           (1 << 25)  /* Activate the indirect access. This bit is self cleared */
#define TW5864_RW               (1 << 24)  /* Read/Write command */

#define TW5864_IND_DATA            0xB804  /* [31:0] Data used to read/write indirect register space */
...
#define TW5864_MV_BK0_FULL       (1 << 0)  /* mv bank0 full status , write "1" to clear */
#define TW5864_MV_BK1_FULL       (1 << 1)  /* mv bank1 full status , write "1" to clear */
#define TW5864_MV_EOF            (1 << 2)  /* slice end status; write "1" to clear */
#define TW5864_MV_DSP_INTR       (1 << 3)  /* mv encode interrupt status; write “1” to clear */
#define TW5864_DSP_WR_OF         (1 << 4)  /* mv write memory overflow, write "1" to clear */
#define TW5864_MV_LEN_SHIFT             5
#define TW5864_MV_LEN (0xff << TW5864_MV_LEN_SHIFT)  /* mv stream length */
#define TW5864_MPI_DDR_SEL      (1 << 13)  /* The configured status bit written into bit 15 of 0xFC04 */
...
#define TW5864_VLC_DONE_INTR     (1 << 1)  /* vlc done */
#define TW5864_AD_VSYNC_INTR     (1 << 3)  /* ad vsync */
#define TW5864_PREV_EOF_INTR     (1 << 4)  /* preview eof */
#define TW5864_PREV_OVERFLOW_INTR (1 << 5)  /* preview overflow interrupt */
#define TW5864_TIMER_INTR        (1 << 6)  /* timer interrupt */
#define TW5864_AUDIO_EOF_INTR    (1 << 8)  /* audio eof */
#define TW5864_IIC_DONE_INTR    (1 << 24)  /* IIC done */
#define TW5864_AD_INTR_REG      (1 << 25)  /* ad interrupt (e.g.: video lost, video format changed) */

#define TW5864_PCI_INTR_CTL       0x18004
/* Define controls in register TW5864_PCI_INTR_CTL */
#define TW5864_PCI_MAST_ENB      (1 << 0)  /* master enable */
#define TW5864_MVD_VLC_MAST_ENB      0x06  /* mvd&vlc master enable */
#define TW5864_AD_MAST_ENB       (1 << 3)  /* (Need to set 0 in TW5864A) */
#define TW5864_PREV_MAST_ENB     (1 << 4)  /* preview master enable */
#define TW5864_PREV_OVERFLOW_ENB (1 << 5)  /* preview overflow enable */
#define TW5864_TIMER_INTR_ENB    (1 << 6)  /* timer interrupt enable */
#define TW5864_JPEG_MAST_ENB     (1 << 7)  /* JPEG master (push mode) enable */
#define TW5864_AU_MAST_ENB_CHN_SHIFT    8
#define TW5864_AU_MAST_ENB_CHN (0xffff << TW5864_AU_MAST_ENB_CHN_SHIFT)  /* audio master channel enable */
#define TW5864_IIC_INTR_ENB     (1 << 24)  /* IIC interrupt enable */
#define TW5864_AD_INTR_ENB      (1 << 25)  /* ad interrupt enable */
#define TW5864_PCI_TAR_BURST_ENB (1 << 26)  /* target burst enable */
#define TW5864_PCI_VLC_BURST_ENB (1 << 27)  /* vlc stream burst enable */
#define TW5864_PCI_DDR_BURST_ENB (1 << 28)  /* ddr burst enable (1 enable, and must set DDR_BRST_EN) */
...
#define TW5864_PREV_INTR_REG   0x0000ffff  /* preview eof interrupt flag */
#define TW5864_AU_INTR_REG_SHIFT       16
#define TW5864_AU_INTR_REG (0xffff << TW5864_AU_INTR_REG_SHIFT)  /* audio eof interrupt flag */
...
#define TW5864_PREV_BUF_FLAG       0xffff  /* preview buffer A/B flag */
#define TW5864_AUDIO_BUF_FLAG_SHIFT    16
#define TW5864_AUDIO_BUF_FLAG (0xffff << TW5864_AUDIO_BUF_FLAG_SHIFT)  /* audio buffer A/B flag */

#define TW5864_IIC                0x18014
/* Define controls in register TW5864_IIC */
#define TW5864_IIC_DATA            0x00ff  /* register data */
#define TW5864_IIC_REG_ADDR_SHIFT       8
#define TW5864_IIC_REG_ADDR (0xff << TW5864_IIC_REG_ADDR_SHIFT)  /* register addr */
#define TW5864_IIC_RW           (1 << 16)  /* rd/wr flag rd=1,wr=0 */
#define TW5864_IIC_DEV_ADDR_SHIFT      17
#define TW5864_IIC_DEV_ADDR (0x7f << TW5864_IIC_DEV_ADDR_SHIFT)  /* device addr */
#define TW5864_IIC_DONE         (1 << 24)  /* iic done, software kick off one time iic transaction through setting this
...
#define TW5864_APP_SOFT_RST      (1 << 0)  /* application software soft reset */
#define TW5864_PCI_INF_VERSION_SHIFT 16
#define TW5864_PCI_INF_VERSION (0xffff << TW5864_PCI_INF_VERSION_SHIFT)  /* PCI interface version, read only */

#define TW5864_VLC_CRC_REG        0x1801C  /* vlc stream crc value, it is calculated in pci module */
#define TW5864_VLC_MAX_LENGTH     0x18020  /* vlc max length, it is defined by software based on software assign
                                              memory space for vlc*/
#define TW5864_VLC_LENGTH         0x18024  /* vlc length of one frame */
...
#define TW5864_PREV_PCI_ENB_CHN   0x18040  /* Configuration register for 9[or 10] CIFs or 1D1+15QCIF Preview mode.
 ...
 */
#define TW5864_VLC_STREAM_BASE_ADDR 0x18080  /* VLC stream base address */
#define TW5864_MV_STREAM_BASE_ADDR 0x18084  /* MV stream base address */
...
#define TW5864_BRST_LENGTH (0x3fff << TW5864_BRST_LENGTH_SHIFT)  /* Length of 32-bit data burst */
#define TW5864_BRST_RW          (1 << 16)  /* Burst Read/Write
                                              0 Read Burst from DDR
                                              1 Write Burst to DDR */
#define TW5864_NEW_BRST_CMD     (1 << 17)  /* Begin a new DDR Burst. This bit is self cleared */
#define TW5864_BRST_END         (1 << 24)  /* DDR Burst End Flag */
#define TW5864_SING_ERR_INTR    (1 << 25)  /* Enable Error Interrupt for Single DDR Access */
#define TW5864_BRST_ERR_INTR    (1 << 26)  /* Enable Error Interrupt for Burst DDR Access */
#define TW5864_BRST_END_INTR    (1 << 27)  /* Enable Interrupt for End of DDR Burst Access */
#define TW5864_SINGLE_ERR       (1 << 28)  /* DDR Single Access Error Flag */
#define TW5864_SINGLE_BUSY      (1 << 29)  /* DDR Single Access Busy Flag */
#define TW5864_BRST_ERR         (1 << 30)  /* DDR Burst Access Error Flag */
#define TW5864_BRST_BUSY        (1 << 31)  /* DDR Burst Access Busy Flag */

#define TW5864_DDR_ADDR           0x80004  /* [27:0] DDR Access Address. Bit [1:0] has to be 0 */
#define TW5864_DPR_BUF_ADDR       0x80008  /* DDR Access Internal Buffer Address. Bit [1:0] has to be 0 */
#define TW5864_DPR_BUF_START      0x84000  /* SRAM Buffer MPI Access Space. Totally 16 KB */
#define TW5864_DPR_BUF_SIZE        0x4000  /* 0x84000 - 0x87FFC */
...
#define TW5864_INDIR_VIN_0(channel) (0x000 + channel * 0x010) /* Read-only register */
/* Define controls in register TW5864_INDIR_VIN_0 */
#define TW5864_INDIR_VIN_0_VDLOSS (1 << 7)  /* 1 Video not present. (sync is not detected in number of
					       consecutive line periods specified by MISSCNT register)
					       0 Video detected. */
#define TW5864_INDIR_VIN_0_HLOCK  (1 << 6)  /* 1 Horizontal sync PLL is locked to the incoming video
					       source.
					       0 Horizontal sync PLL is not locked. */
#define TW5864_INDIR_VIN_0_SLOCK (1 << 5)  /* 1 Sub-carrier PLL is locked to the incoming video source.
					      0 Sub-carrier PLL is not locked. */
#define TW5864_INDIR_VIN_0_FLD (1 << 4)  /* 1 Even field is being decoded.
					    0 Odd field is being decoded. */
#define TW5864_INDIR_VIN_0_VLOCK (1 << 3)  /* 1 Vertical logic is locked to the incoming video source.
					      0 Vertical logic is not locked. */
#define TW5864_INDIR_VIN_0_MONO (1 << 1)  /* 1 No color burst signal detected.
					     0 Color burst signal detected. */
#define TW5864_INDIR_VIN_0_DET50 (1 << 0)  /* 0 60Hz source detected
...
#define TW5864_INDIR_VIN_1_VCR (1 << 7)  /* VCR signal indicator. Read-only. */
#define TW5864_INDIR_VIN_1_WKAIR (1 << 6)  /* Weak signal indicator 2. Read-only. */
#define TW5864_INDIR_VIN_1_WKAIR1 (1 << 5)  /* Weak signal indicator controlled by WKTH. Read-only. */
#define TW5864_INDIR_VIN_1_VSTD (1 << 4)  /* 1 = Standard signal
					     0 = Non-standard signal
					     Read-only */
#define TW5864_INDIR_VIN_1_NINTL (1 << 3)  /* 1 = Non-interlaced signal
					      0 = interlaced signal
					      Read-only */
#define TW5864_INDIR_VIN_1_VSHP 0x07  /* Vertical Sharpness Control. Writable.
					 0 = None (default)
					 7 = Highest
					 **Note: VSHP must be set to ‘0’ if COMB = 0 */

#define TW5864_INDIR_VIN_2_HDELAY_XY_LO(channel) (0x002 + channel * 0x010)  /* HDELAY_XY[7:0] */
#define TW5864_INDIR_VIN_3_HACTIVE_XY_LO(channel) (0x003 + channel * 0x010)  /* HACTIVE_XY[7:0] */
#define TW5864_INDIR_VIN_4_VDELAY_XY_LO(channel) (0x004 + channel * 0x010)  /* VDELAY_XY[7:0] */
#define TW5864_INDIR_VIN_5_VACTIVE_XY_LO(channel) (0x005 + channel * 0x010)  /* VACTIVE_XY[7:0] */
...
#define TW5864_INDIR_VIN_8_SCURVE (1 << 7)  /* This bit controls the center frequency of the peaking filter. The corresponding gain adjustment is HFLT.
					       0 Low
					       1 center */
...
#define TW5864_INDIR_VIN_D(channel) (0x00D + channel * 0x010)  /* Read-only */
/* Define controls in register TW5864_INDIR_VIN_D */
#define TW5864_INDIR_VIN_D_CSBAD (1 << 3)  /* Macrovision color stripe detection may be un-reliable */
#define TW5864_INDIR_VIN_D_MCVSN (1 << 2)  /* Macrovision AGC pulse detected */
#define TW5864_INDIR_VIN_D_CSTRIPE (1 << 1)  /* Macrovision color stripe protection burst detected */
#define TW5864_INDIR_VIN_D_CTYPE2 (1 << 0)  /* This bit is valid only when color stripe protection is detected, i.e. if CSTRIPE=1,
					       1 Type 2 color stripe protection
					       0 Type 3 color stripe protection */

#define TW5864_INDIR_VIN_E(channel) (0x00E + channel * 0x010)  /* Read-only */
/* Define controls in register TW5864_INDIR_VIN_E */
#define TW5864_INDIR_VIN_E_DETSTUS (1 << 7)  /* Read-only.
						0 Idle
...
#define TW5864_INDIR_VIN_E_ATREG (1 << 3)  /* 1 Disable the shadow registers
...
#define TW5864_INDIR_VIN_F_ATSTART (1 << 7)  /* 1 Writing 1 to this bit will manually initiate the auto format
						detection process. This bit is a self-clearing bit
						0 Manual initiation of auto format detection is done.
						(Default) */
#define TW5864_INDIR_VIN_F_PAL60EN (1 << 6)  /* Enable recognition of PAL60 (Default) */
#define TW5864_INDIR_VIN_F_PALCNEN (1 << 5)  /* Enable recognition of PAL (CN). (Default) */
#define TW5864_INDIR_VIN_F_PALMEN (1 << 4)  /* Enable recognition of PAL (M). (Default) */
#define TW5864_INDIR_VIN_F_NTSC44EN (1 << 3)  /* Enable recognition of NTSC 4.43. (Default) */
#define TW5864_INDIR_VIN_F_SECAMEN (1 << 2)  /* Enable recognition of SECAM. (Default) */
#define TW5864_INDIR_VIN_F_PALBEN (1 << 1)  /* Enable recognition of PAL (B, D, G, H, I). (Default) */
#define TW5864_INDIR_VIN_F_NTSCEN (1 << 0)  /* Enable recognition of NTSC (M). (Default) */
 ...
 * 15 2.75
 */
#define TW5864_INDIR_AIGAIN1 0x060  /* [3:0] channel 0, [7:4] channel 1 */
#define TW5864_INDIR_AIGAIN2 0x061  /* [3:0] channel 2, [7:4] channel 3 */
...
#define TW5864_INDIR_AIN_MIX_DERATIO (1 << 5)  /* Disable the mixing ratio value for all audio.
...
#define TW5864_INDIR_AIN_0x0E3_EXT_ADATP (1 << 7)  /* ADATP signal is coming from external ADPCM decoder, instead
						      of on-chip ADPCM decoder */
#define TW5864_INDIR_AIN_0x0E3_ACLKPPOLO (1 << 6)  /* ACLKP output signal polarity inverse */
#define TW5864_INDIR_AIN_0x0E3_ACLKRPOL (1 << 5)  /* ACLKR input signal polarity inverse.
						     0 Not inversed (Default)
						     1 Inversed */
#define TW5864_INDIR_AIN_0x0E3_ACLKPPOLI (1 << 4)  /* ACLKP input signal polarity inverse.
						      0 Not inversed (Default)
						      1 Inversed */
#define TW5864_INDIR_AIN_0x0E3_AFAUTO (1 << 3)  /* ACKI [21:0] control automatic set up with AFMD registers
...
#define TW5864_INDIR_AIN_0x0E3_AFMD 0x07  /* AFAUTO control mode
...
#define TW5864_INDIR_AIN_0x0E4_I2S8MODE (1 << 7)  /* 8bit I2S Record output mode.
						     0 L/R half length separated output (Default).
						     1 One continuous packed output equal to DSP output
						     format. */
#define TW5864_INDIR_AIN_0x0E4_MASCKMD (1 << 6)  /* Audio Clock Master ACLKR output wave format.
...
#define TW5864_INDIR_AIN_0x0E4_PBINSWAP (1 << 5)  /* Playback ACLKP/ASYNP/ADATP input data MSB-LSB swapping */
#define TW5864_INDIR_AIN_0x0E4_ASYNRDLY (1 << 4)  /* ASYNR input signal delay.
						     0 No delay
						     1 Add one 27MHz period delay in ASYNR signal input */
#define TW5864_INDIR_AIN_0x0E4_ASYNPDLY (1 << 3)  /* ASYNP input signal delay.
						     0 no delay
						     1 add one 27MHz period delay in ASYNP signal input */
#define TW5864_INDIR_AIN_0x0E4_ADATPDLY (1 << 2)  /* ADATP input data delay by one ACLKP clock.
...
#define TW5864_INDIR_AIN_0x0E4_INLAWMD 0x03  /* Select u-Law/A-Law/PCM/SB data input format on ADATP pin.
						0 PCM input (Default)
						1 SB (Signed MSB bit in PCM data is inverted) input
						2 u-Law input
						3 A-Law input */

#define TW5864_INDIR_AIN_A5DETENA 0x0E5  /* Enable state register updating and interrupt request of audio AIN5 detection for each input */

/* Some registers skipped TODO */

#define TW5864_INDIR_ID 0x0FE  /* [7:3]: DEV_ID The TW5864 product ID code is 01000
 ...
 */
#define TW5864_INDIR_INTERRUPT1 0x2D0  /* 0x2D0~0x2D7: [63:0] bits */
#define TW5864_INDIR_INTERRUPT2 0x2E0  /* 0x2E0~0x2E3: [95:64] bits */
 ...
 * 95:80 Line mode overflow interrupt for channel 0 ~ 15
 */
#define TW5864_INDIR_INTERRUPT_MASK1 0x2D8  /* 0x2D8~0x2DF: [63:0] bits */
#define TW5864_INDIR_INTERRUPT_MASK2 0x2E8  /* 0x2E8~0x2EB: [95:64] bits */
...
#define TW5864_INDIR_DETECTION_CTL0_MD_DIS (1 << 5)  /* Disable the motion and blind detection.
							0 Enable motion and blind detection (default)
							1 Disable motion and blind detection */
#define TW5864_INDIR_DETECTION_CTL0_MD_STRB (1 << 3)  /* Request to start motion detection on manual trigger mode
							 0 None Operation (default)
							 1 Request to start motion detection */
#define TW5864_INDIR_DETECTION_CTL0_MD_STRB_EN (1 << 2)  /* Select the trigger mode of motion detection
							    0 Automatic trigger mode of motion detection (default)
							    1 Manual trigger mode for motion detection */
#define TW5864_INDIR_DETECTION_CTL0_BD_CELSENS 0x03  /* Define the threshold of cell for blind detection.
...
#define TW5864_INDIR_DETECTION_CTL1_MD_PIXEL_OS 0x0f  /* Adjust the horizontal starting position for motion detection
							 0 0 pixel (default)
							 : :
							 15 15 pixels */
...
#define TW5864_INDIR_DETECTION_CTL2_MD_REFFLD (1 << 7)  /* Control the updating time of reference field for motion detection.
...
#define TW5864_INDIR_DETECTION_CTL2_MD_LVSENS 0x1f  /* Control the level sensitivity of motion detector.
						       0 More sensitive (default)
						       : :
						       15 Less sensitive */
...
#define TW5864_INDIR_DETECTION_CTL3_MD_SPEED 0x3f  /* Control the velocity of motion detector.
...
#define TW5864_INDIR_DETECTION_CTL4_BD_LVSENS 0x0f  /* Define the threshold of level for blind detection.
						       0 Low threshold (More sensitive) (default)
						       : :
...
#define TW5864_INDIR_DETECTION_CTL5_ND_LVSENS 0x0f  /* Define the threshold of level for night detection.
						       0 Low threshold (More sensitive) (default)
						       : :
						       3 High threshold (Less sensitive) */

#define TW5864_INDIR_MD_BASE_ADDR 0x380  /* [11:0] The base address of the motion detection buffer. This address is
...
#define TW5864_INDIR_MD_STRB 0x386  /* [15:0] MD strobe has been performed at channel n (read only) */
#define TW5864_INDIR_NOVID_DET 0x388  /* NO_VIDEO Detected from channel n (read only) */
#define TW5864_INDIR_MD_DET 0x38A  /* Motion Detected from channel n (read only) */
#define TW5864_INDIR_BD_DET 0x38C  /* Blind Detected from channel n (read only) */
#define TW5864_INDIR_ND_DET 0x38E  /* Night Detected from channel n (read only) */
...
#define TW5864_INDIR_MD_DI_CNT 0x3B8  /* [9:0] The motion cell count of a
					 specific channel selected by 0x382.
					 This is for DI purpose */
#define TW5864_INDIR_MD_DI_CELLSENS 0x3BA  /* The motion detection cell sensitivity for DI purpose */
#define TW5864_INDIR_MD_DI_LVSENS 0x3BB  /* The motion detection threshold level for DI purpose */
...
#define TW5864_INDIR_MASK_CH_SEL 0x3FE  /* [4:0] The channel selection to access masks in 0x3E0 ~ 0x3F7 */
