...
#define TW5864_EMU_EN_ME         (1 << 1)
/* Enable bit for Sensor Interface module */
#define TW5864_EMU_EN_SEN        (1 << 2)
/* Enable bit for Host Burst Access */
#define TW5864_EMU_EN_BHOST      (1 << 3)
/* Enable bit for Loop Filter module */
#define TW5864_EMU_EN_LPF        (1 << 4)
...
/* VLC Slice end flag */
#define TW5864_VLC_SLICE_END     (1 << 0)
/* Master Slice End Flag */
#define TW5864_MAS_SLICE_END     (1 << 4)
/* Host to start a new slice Address */
#define TW5864_START_NSLICE     (1 << 15)
 ...
 * 1: Decode
 */
#define TW5864_DSP_CODEC_MODE    (1 << 0)
/*
 ...
 * 1 1CIF in 1 MB
 */
#define TW5864_CIF_MAP_MD        (1 << 6)
/*
 * 0 2 falf D1 in 1 MB
 * 1 1 half D1 in 1 MB
 */
#define TW5864_HD1_MAP_MD        (1 << 7)
/* VLC Stream valid */
#define TW5864_VLC_VLD           (1 << 8)
/* MV Vector Valid */
#define TW5864_MV_VECT_VLD       (1 << 9)
/* MV Flag Valid */
#define TW5864_MV_FLAG_VLD      (1 << 10)
...
#define TW5864_QPEL_EN           (1 << 0)
/* Enable half pel search mode */
#define TW5864_HPEL_EN           (1 << 1)
/* Enable motion search mode */
#define TW5864_ME_EN             (1 << 2)
/* Enable Intra mode */
 ...
 */
#define TW5864_VLC_BYTE_SWP      (1 << 6)
/* Enable Adding 03 circuit for VLC stream */
#define TW5864_VLC_ADD03_EN      (1 << 7)
 ...
 */
#define TW5864_VLC_INF_SEL      (1 << 13)
/* Enable VLC overflow control */
#define TW5864_VLC_OVFL_CNTL    (1 << 14)
/*
 * 1 PCI Master Mode
 * 0 Non PCI Master Mode
 */
#define TW5864_VLC_PCI_SEL      (1 << 15)
/*
...
#define TW5864_VLC_BK0_FULL      (1 << 0)
/* VLC BK1 full status, write ‘1’ to clear */
#define TW5864_VLC_BK1_FULL      (1 << 1)
/* VLC end slice status, write ‘1’ to clear */
#define TW5864_VLC_END_SLICE     (1 << 2)
/* VLC Buffer overflow status, write ‘1’ to clear */
#define TW5864_DSP_RD_OF         (1 << 3)
...
#define TW5864_ADPCM_DEC         (1 << 0)
/* ADPCM input data enable */
#define TW5864_ADPCM_IN_DATA     (1 << 1)
/* ADPCM encoder enable */
#define TW5864_ADPCM_ENC         (1 << 2)
...
#define TW5864_SPK_ORG_EN       (1 << 16)
/*
 * 0 16bit
 * 1 8bit
 */
#define TW5864_AD_BIT_MODE      (1 << 17)
...
#define TW5864_TEST_ADLOOP_EN   (1 << 30)
/*
 * 0 Asynchronous Mode or PCI target mode
 * 1 PCI Initiator Mode
 */
#define TW5864_AUD_MODE         (1 << 31)
...
#define TW5864_SPK_ADPCM_EN     (1 << 16)
 ...
 */
#define TW5864_PCI_FLOW_EN      (1 << 16)
/*
 ...
 * send one frame.
 */
#define TW5864_PCI_AUD_FRM_EN   (1 << 17)
 ...
 */
#define TW5864_VLC_OUT_EDGE      (1 << 3)
...
#define TW5864_MPI_DDR_SEL      (1 << 13)
 ...
 */
#define TW5864_MPI_DDR_SEL2     (1 << 15)
...
/* vlc done */
#define TW5864_VLC_DONE_INTR     (1 << 1)
/* ad vsync */
#define TW5864_AD_VSYNC_INTR     (1 << 3)
/* preview eof */
#define TW5864_PREV_EOF_INTR     (1 << 4)
/* preview overflow interrupt */
#define TW5864_PREV_OVERFLOW_INTR (1 << 5)
/* timer interrupt */
#define TW5864_TIMER_INTR        (1 << 6)
/* audio eof */
#define TW5864_AUDIO_EOF_INTR    (1 << 8)
/* IIC done */
#define TW5864_IIC_DONE_INTR    (1 << 24)
/* ad interrupt (e.g.: video lost, video format changed) */
#define TW5864_AD_INTR_REG      (1 << 25)

#define TW5864_PCI_INTR_CTL       0x18004
/* Define controls in register TW5864_PCI_INTR_CTL */
/* master enable */
#define TW5864_PCI_MAST_ENB      (1 << 0)
/* mvd&vlc master enable */
#define TW5864_MVD_VLC_MAST_ENB      0x06
/* (Need to set 0 in TW5864A) */
#define TW5864_AD_MAST_ENB       (1 << 3)
/* preview master enable */
#define TW5864_PREV_MAST_ENB     (1 << 4)
/* preview overflow enable */
#define TW5864_PREV_OVERFLOW_ENB (1 << 5)
/* timer interrupt enable */
#define TW5864_TIMER_INTR_ENB    (1 << 6)
/* JPEG master (push mode) enable */
#define TW5864_JPEG_MAST_ENB     (1 << 7)
...
#define TW5864_IIC_INTR_ENB     (1 << 24)
/* ad interrupt enable */
#define TW5864_AD_INTR_ENB      (1 << 25)
/* target burst enable */
#define TW5864_PCI_TAR_BURST_ENB (1 << 26)
/* vlc stream burst enable */
#define TW5864_PCI_VLC_BURST_ENB (1 << 27)
...
/* master enable */
#define TW5864_PCI_VLC_INTR_ENB  (1 << 1)
/* mvd and vlc master enable */
#define TW5864_PCI_PREV_INTR_ENB (1 << 4)
/* ad vsync master enable */
#define TW5864_PCI_PREV_OF_INTR_ENB (1 << 5)
/* jpeg master enable */
#define TW5864_PCI_JPEG_INTR_ENB  (1 << 7)
/* preview master enable */
 ...
 */
#define TW5864_BRST_RW          (1 << 16)
/* Begin a new DDR Burst. This bit is self cleared */
#define TW5864_NEW_BRST_CMD     (1 << 17)
/* DDR Burst End Flag */
#define TW5864_BRST_END         (1 << 24)
/* Enable Error Interrupt for Single DDR Access */
#define TW5864_SING_ERR_INTR    (1 << 25)
/* Enable Error Interrupt for Burst DDR Access */
#define TW5864_BRST_ERR_INTR    (1 << 26)
/* Enable Interrupt for End of DDR Burst Access */
#define TW5864_BRST_END_INTR    (1 << 27)
/* DDR Single Access Error Flag */
#define TW5864_SINGLE_ERR       (1 << 28)
/* DDR Single Access Busy Flag */
#define TW5864_SINGLE_BUSY      (1 << 29)
/* DDR Burst Access Error Flag */
#define TW5864_BRST_ERR         (1 << 30)
/* DDR Burst Access Busy Flag */
#define TW5864_BRST_BUSY        (1 << 31)
 ...
 * 1 center
 */
#define TW5864_INDIR_VIN_8_SCURVE (1 << 7)
...
#define TW5864_INDIR_VIN_D_CSBAD (1 << 3)
/* Macrovision AGC pulse detected */
#define TW5864_INDIR_VIN_D_MCVSN (1 << 2)
 ...
 */
#define TW5864_INDIR_VIN_D_CTYPE2 (1 << 0)
 ...
 */
#define TW5864_INDIR_VIN_E_DETSTUS (1 << 7)
/*
 ...
 */
#define TW5864_INDIR_VIN_E_ATREG (1 << 3)
/*
 ...
 * (Default)
 */
#define TW5864_INDIR_VIN_F_ATSTART (1 << 7)
/* Enable recognition of PAL60 (Default) */
#define TW5864_INDIR_VIN_F_PAL60EN (1 << 6)
/* Enable recognition of PAL (CN). (Default) */
#define TW5864_INDIR_VIN_F_PALCNEN (1 << 5)
/* Enable recognition of PAL (M). (Default) */
#define TW5864_INDIR_VIN_F_PALMEN (1 << 4)
/* Enable recognition of NTSC 4.43. (Default) */
#define TW5864_INDIR_VIN_F_NTSC44EN (1 << 3)
/* Enable recognition of SECAM. (Default) */
#define TW5864_INDIR_VIN_F_SECAMEN (1 << 2)
/* Enable recognition of PAL (B, D, G, H, I). (Default) */
#define TW5864_INDIR_VIN_F_PALBEN (1 << 1)
 ...
 */
#define TW5864_INDIR_AIN_MIX_DERATIO (1 << 5)
 ...
 */
#define TW5864_INDIR_AIN_0x0E3_EXT_ADATP (1 << 7)
/* ACLKP output signal polarity inverse */
#define TW5864_INDIR_AIN_0x0E3_ACLKPPOLO (1 << 6)
/*
 * ACLKR input signal polarity inverse.
 * 0 Not inversed (Default)
 * 1 Inversed
 */
#define TW5864_INDIR_AIN_0x0E3_ACLKRPOL (1 << 5)
/*
 * ACLKP input signal polarity inverse.
 * 0 Not inversed (Default)
 * 1 Inversed
 */
#define TW5864_INDIR_AIN_0x0E3_ACLKPPOLI (1 << 4)
/*
 ...
 */
#define TW5864_INDIR_AIN_0x0E3_AFAUTO (1 << 3)
/*
 * AFAUTO control mode
 ...
 * format.
 */
#define TW5864_INDIR_AIN_0x0E4_I2S8MODE (1 << 7)
/*
 ...
 */
#define TW5864_INDIR_AIN_0x0E4_ADATPDLY (1 << 2)
/*
 ...
 */
#define TW5864_INDIR_DETECTION_CTL0_MD_STRB_EN (1 << 2)
/*
 ...
 */
#define TW5864_INDIR_DETECTION_CTL2_MD_REFFLD (1 << 7)
/*
