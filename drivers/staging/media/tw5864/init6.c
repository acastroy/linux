...
w(0x00001000,0x0000991C); /* chip f5880300 */
w(TW5864_DSP_QP,0x0000001C); /* chip f5880300 */
w(TW5864_DSP_REF_MVP_LAMBDA,0x000000C0); /* chip f5880300 */
...
w(TW5864_DSP_I4x4_WEIGHT,0x00000006); /* chip f5880300 */
...
//w(TW5864_VLC_STREAM_BASE_ADDR,0x35900000); /* chip f5880300 */
//w(TW5864_MV_STREAM_BASE_ADDR,0x35840000); /* chip f5880300 */
